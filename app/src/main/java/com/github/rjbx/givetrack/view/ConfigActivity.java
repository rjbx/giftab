...
//                sortPref.setValueIndex(sortPref.getEntries().length - 1);
            ...
            ListPreference orderPref = (ListPreference) findPreference(getString(R.string.pref_indexRelevance_key));
...
//            handlePreferenceChange(findPreference(getString(R.string.pref_indexSize_key)), this);
            handlePreferenceChange(findPreference(getString(R.string.pref_indexRelevance_key)), this);
            ...
            if (getString(R.string.pref_reset_key).equals(preferenceKey)) {
                ...
                for (Map.Entry<String, Object> entry : entrySet) {
                    ...
                    if (k.contains("index")) {
                        ...
                        if (k.equals(getString(R.string.pref_indexRelevance_key))) e.putString(k, "DESC");
